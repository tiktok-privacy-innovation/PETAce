...
macro(petace_combine_archives target dependency)
    if(MSVC)
...
macro(petace_fetch_thirdparty_content content_file)
    set(PETACE_FETCHCONTENT_BASE_DIR_OLD ${FETCHCONTENT_BASE_DIR})
    set(FETCHCONTENT_BASE_DIR ${PETACE_THIRDPARTY_DIR} CACHE STRING "" FORCE)
    include(${content_file})
    set(FETCHCONTENT_BASE_DIR ${PETACE_FETCHCONTENT_BASE_DIR_OLD} CACHE STRING "" FORCE)
    unset(PETACE_FETCHCONTENT_BASE_DIR_OLD)
endmacro()
